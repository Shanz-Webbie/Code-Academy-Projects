...
#print(early_bird_menu.calculate_bill(['salumeria plate', 'mushrom ravioli (vegan)']))
...
arepas_place = Franchise('189 Fitzegerals Avenue', menus)

#print(flagship_store.available_menus(17))

basta = Business("Basta Fazoolin' with my Heart", [flagship_store, new_installment])
arepa = Business("Take a' Arepa", [flagship_store, new_installment, arepas_place])
